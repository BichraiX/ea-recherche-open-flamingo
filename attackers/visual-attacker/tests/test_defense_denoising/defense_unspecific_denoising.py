...
for sig in sigmas:
    ...
    print(f"Sigma: {sig}, Denoised Unspecific Attack Exact Prediction: {denoised_right_label_rate:.2f}%")
...
plt.plot(sigmas, denoised_unspecific_attack_success_rates, label="Denoised Unspecific Attack", marker='o', color='orange')
